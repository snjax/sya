...
func EditSection(t *Task, name string, content []byte) {
	idx := sectionIndex(t, name)
	if idx < 0 {
		appendSection(t, name, content)
		return
	}
...
func appendSection(t *Task, name string, content []byte) {
